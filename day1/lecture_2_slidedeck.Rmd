...
date: "0900&ndash;1200 CET Monday 24th March, 2025"
output:
...
portal_data %>%
  ...
  droplevels() %>%
  dplyr::mutate(count = captures) -> model_data
...
portal_data %>%
  ...
  dplyr::mutate(`relative abundance` = captures / total) %>%
  dplyr::ungroup() %>%
...
```{r basis-functions, fig.height=6.225, fig.width = 9.975, dev = 'svg', echo=FALSE,message=FALSE,warning=FALSE,fig.show='hide'}
set.seed(7)
N <- 400
...
data <- data.frame(x = x,
                   y = y)
theme_set(theme_classic(base_size = 23, base_family = 'serif'))
...
```{r basis-functions-weights, fig.height=6.225, fig.width = 9.975, dev = 'svg',  echo=FALSE,message=FALSE,warning=FALSE,fig.show='hide'}
set.seed(7)
N <- 400
y <- mvgam::sim_mvgam(T = N, prop_missing = 0,
                      prop_train = 1,
...
<img src="resources/basis_weights4.gif" style="position:fixed; right:5%; top:30%; width:525px; height:350px; border:none;" />

<img src="resources/basis_weights20.gif" style="position:fixed; left:5%; top:30%; width:525px; height:350px; border:none;" />
...
```{r obs_properties, echo=FALSE,fig.show='hide', fig.height=6.2, fig.width=1.9*6.2, dev = 'svg', warning=FALSE, message=FALSE}
...
```{r year_random_ests, fig.show='hide', fig.height=6.2, fig.width=1.9*6.2, dev = 'svg', echo=FALSE}
...
```{r year_random_mcmcplot, fig.show='hide', fig.height=6.2, fig.width=1.9*6.2, dev = 'svg', warning=FALSE, message=FALSE, echo = FALSE}
...
```{r year_random_preds, fig.show='hide', fig.height=6.2, fig.width=1.9*6.2, dev = 'svg', warning=FALSE, message=FALSE,echo=FALSE}
...
```{r year_smooth_ests, fig.show='hide', fig.height=6.2, fig.width=1.9*6.2, dev = 'svg', echo=FALSE}
...
```{r year_smooth_conds, fig.show='hide', fig.height=6.2, fig.width=1.9*6.2, dev = 'svg', warning=FALSE, message=FALSE, echo=FALSE}
...
```{r year_smooth_preds, fig.show='hide', fig.height=6.2, fig.width=1.9*6.2, dev = 'svg', warning=FALSE, message=FALSE,echo=FALSE}
...
```{r year_temp_smooth_est, fig.show='hide', fig.height=6.2, fig.width=1.9*6.2, dev = 'svg', echo=FALSE, message=FALSE}
...
## A smooth of time
```{r echo = FALSE}
load('cache_not_for_upload/lec2_temp_time_smooth.rds')
```
...
## Diagnostics
```{r echo=FALSE}
plot(temp_time_smooth, type = 'residuals') &
  theme_bw(base_size = 14, base_family = 'serif')
```

---

## Hindcast predictions `r fontawesome::fa("face-smile-beam")`
```{r echo=FALSE}
plot(hindcast(temp_time_smooth)) +
  theme_classic(base_size = 17, base_family = 'serif')
```
