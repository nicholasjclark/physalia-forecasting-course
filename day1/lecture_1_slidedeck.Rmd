...
```{r ar_sim, fig.show='hide', fig.height=4, fig.width=1.9*4}
...
```{r ar_simneg, fig.show='hide', fig.height=4, fig.width=1.9*4}
# set seed for reproducibility
set.seed(1111)
...
```{r ar3_sim, fig.show='hide', fig.height=4, fig.width=1.9*4}
# set seed for reproducibility
set.seed(1111)
...
```{r echo = FALSE}
data("AirPassengers")
plot(AirPassengers, bty = 'l', lwd = 2,
     col = 'darkred')
```
...
```{r ar1_acf, fig.show='hide', fig.height=4, fig.width=1.9*4}
# set seed for reproducibility
set.seed(1111)
...
```{r ar1_pacf, fig.show='hide', fig.height=4, fig.width=1.9*4}
# set seed for reproducibility
set.seed(1111)
...
```{r death_ccf, fig.show='hide', fig.height=4, fig.width=1.9*4}
...
```{r gas_acf, fig.show='hide', fig.height=4, fig.width=1.9*4}
...
## plot the trend
lines(trend, lwd = 3, col = 'white')
lines(trend, lwd = 2, col = 'darkred')
```
...
mypar()
data("AirPassengers")
plot(as.vector(AirPassengers), bty = 'l', lwd = 2.5,
     type = 'l',
     col = 'darkred',
     xlab = '', 
     ylab = 'Air passengers',
...
cycle <- predict(mod, exclude = 's(time)',
                 type = 'terms')
lines(cycle, lwd = 3, col = 'white')
lines(cycle, lwd = 2, col = 'darkblue')
box(bty = 'l', lwd = 2)
