...
library('mvgam')
library('fontawesome')
library('ggplot2'); theme_set(theme_bw(base_size = 20, base_family = 'serif'))
```
...
---
## About me
<img src="resources/NicholasClark.jpg" style="position:fixed; right:7%; top:9%; width:300px; height:300px; border:none;" />

<img src="resources/uqmap.png" style="position:fixed; right:0%; top:56%; width:454px; height:296px; border:none;" />

UQ Amplify Early Career Fellow
...
mypar()
data("AirPassengers")
plot(AirPassengers / 10, bty = 'l', lwd = 3.5,
     col = 'darkred',
     ylab = 'Air passengers (hundreds)')
```
...
mypar()
portal_data %>%
  dplyr::filter(series == 'PP') -> model_data
mylines(x = model_data$captures,
        xlab = 'Time',
...
plot(gas,bty = 'l', lwd = 3.5,
     col = 'grey75', ylab = 'gas (thousands of units)')

## plot the trend
lines(trend, lwd = 4.75, col = 'white')
lines(trend, lwd = 3, col = 'darkred')
```
...
mypar()
data("AirPassengers")
plot(as.vector(AirPassengers / 10), bty = 'l', lwd = 3.5,
     type = 'l',
     col = 'darkred',
     xlab = '', 
     ylab = 'Air passengers (hundreds)',
...
# STL decomposition
decomp <- stl(AirPassengers / 10, s.window = 9)
...
lines(cycle, lwd = 4.75, col = 'white')
lines(cycle, lwd = 3, col = 'darkblue')
box(bty = 'l', lwd = 2)

# add labels
text(x = 145, y = trend[144], labels = 'Trend',
     adj = 0,
     col = 'darkred', cex = 1.85)
text(x = 145, y = 1, labels = 'Seasonality',
     adj = 0,
     col = 'darkblue', cex = 1.85, xpd = TRUE)
```
---
...
```{r,fig.height = 6.5, fig.width = 2.2 * 6, echo=FALSE}
set.seed(5)
N = 70
