...
date: "0900&ndash;1200 CET Thursday 27th May, 2025"
output:
...
- [State-Space Vector Autoregressions in `mvgam`](https://ecogambler.netlify.app/blog/vector-autoregressions/)
...
mvgam::plot_mvgam_series(data = beta_temp$data_train, 
                         series = 'all',
                         y = 'Count') +
...
Series-specific smooth is a deviation from a "shared" smooth
...
## Trend estimates
```{r echo=FALSE}
plot(varmod, type = 'trend', series = 1,
     newdata = vardat$data_test,
     ylab = '', 
     xlab = '') + 
  theme_bw(base_size = 15, base_family = 'serif') +
  labs(subtitle = 'Series 1') +
  plot(varmod, type = 'trend', series = 2,
       newdata = vardat$data_test,
       ylab = '', 
       xlab = '') + 
  theme_bw(base_size = 15, base_family = 'serif') +
  labs(subtitle = 'Series 2') +
  plot(varmod, type = 'trend', series = 3,
       newdata = vardat$data_test,
       ylab = '', 
       xlab = '') + 
  theme_bw(base_size = 15, base_family = 'serif') +
  labs(subtitle = 'Series 3') +
  plot(varmod, type = 'trend', series = 4,
       newdata = vardat$data_test,
       ylab = '', 
       xlab = '') + 
  theme_bw(base_size = 15, base_family = 'serif') +
  labs(subtitle = 'Series 4')
```
...
## Trend estimates
```{r echo=FALSE}
plot(dfmod, type = 'trend', series = 1,
     newdata = vardat$data_test,
     ylab = '', 
     xlab = '') + 
  theme_bw(base_size = 15, base_family = 'serif') +
  labs(subtitle = 'Series 1') +
  plot(dfmod, type = 'trend', series = 2,
       newdata = vardat$data_test,
       ylab = '', 
       xlab = '') + 
  theme_bw(base_size = 15, base_family = 'serif') +
  labs(subtitle = 'Series 2') +
  plot(dfmod, type = 'trend', series = 3,
       newdata = vardat$data_test,
       ylab = '', 
       xlab = '') + 
  theme_bw(base_size = 15, base_family = 'serif') +
  labs(subtitle = 'Series 3') +
  plot(dfmod, type = 'trend', series = 4,
       newdata = vardat$data_test,
       ylab = '', 
       xlab = '') + 
  theme_bw(base_size = 15, base_family = 'serif') +
